...
nodes = [
  { :hostname => 'master.hdpclust.home',    :ip => '192.168.48.10', :box => 'puppetlabs/ubuntu-12.04-64-puppet',  :cpus => '1',  :ram => '3072' },
  { :hostname => 'hadoop1.hdpclust.home',   :ip => '192.168.48.11', :box => 'puppetlabs/ubuntu-12.04-64-puppet',  :cpus => '1',  :ram => '1024' },
  { :hostname => 'hadoop2.hdpclust.home',   :ip => '192.168.48.12', :box => 'puppetlabs/ubuntu-12.04-64-puppet',  :cpus => '1',  :ram => '1024' },
]
